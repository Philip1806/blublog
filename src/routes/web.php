...
Route::group(
    ...
    static function () {
        ...
        Route::post('/blublog/img_upload', 'BlublogAPIController@img_upload')->name('blublog.posts.img_upload')->middleware('auth');
        ...
        Route::post('/blublog/check-version/', 'BlublogSettingController@justtest')->name('blublog.api.justtest')->middleware('throttle:10,1');;
